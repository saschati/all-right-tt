...
import ChooseDataAndTimeLessonController from '@/controllers/Quiz/ChooseDataAndTimeLessonController'
...
export default [
  ...
  route(Path.QUIZ_CHOOSE_DATA_AND_TIME_LESSON, ChooseDataAndTimeLessonController, RouterAccess.ALL),
]
